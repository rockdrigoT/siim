...
<body>
    ...
    <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4">
        <div
            ...
            <a href="reporte_municipal_excel.php?municipio=<?= $municipio ?>" class='btn btn-success'>exportar excel</a>
       ...
       ?>
            ...
            while ($row=mysqli_fetch_object($lsFortapaz)){
                ...
                while($row=mysqli_fetch_object($anexoFortapaz)){
                    ...
                    echo "$".number_format($totalFortapazAutorizado,2);
                }
                echo "</td>
                </tr>";
            };
