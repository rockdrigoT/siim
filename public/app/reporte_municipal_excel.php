...
$nombrempio= $_GET['nombrempio'];
$fecha=date('Y-m-d');
$file="ficha_".$nombrempio."_".$fecha.".doc";
    ...
    <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4">
        <div
            ...
            while ($row1=mysqli_fetch_object($nomMun)){
                ...
                echo "<h1 class='h2'>".$nombreMunicipio."</h1><p class='fecha'>Actualización al ".$fecha."</p>";
            }else{
       ...
       while($row=mysqli_fetch_object($indicadoresBienestar)){
           ...
           echo "<tr style='font-family: Arial, Helvetica, sans-serif; font-size:0.85em; text-align:center; color:white; background-color:#6A0f49'>
           <td>Beneficiarios por hogar:<br> ".number_format($beneficiarios_por_hogar,2)."</td>
           <td>Ranking municipal: <br>".$rk."</td>
           <td>Cobertura adultos mayores: <br>".(number_format($cobertura_adultos_mayores,2)*100)." %</td>
           <td>Cobertura discapacidad: <br>".(number_format($cobertura_discapacidad,2)*100)." %</td>
           </tr>";
       }
       ?>
            </table>
            <br>
            <table class='table mitabla' style='font-family: Arial, Helvetica, sans-serif; font-size: 0.8em;'>
                <?php
                 $conx = new consulta();
                 ...
                 while($rowB=mysqli_fetch_object($programasBienestar)){
                    ...
                    <tr class='cabezaTabla' style='background-color:#ffc3d0'>
                    <td>Total municipal</td>
                    <td style='text-align: center;'>".number_format($ben_total)."</td>
                    ...
                    <td>".number_format($P0006_ben)."</td>
                    <td>$".number_format($P0006_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0010_ben)."</td>
                    <td>$".number_format($p0010_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0837_ben)."</td>
                    <td>$".number_format($p0837_monto)."</td>
                    </tr>";
                    }else{
                    }
                    ...
                    <td>".number_format($p0838_ben)."</td>
                    <td>$".number_format($p0838_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0844_ben)."</td>
                    <td>$".number_format($p0844_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0846_ben)."</td>
                    <td>$".number_format($p0846_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0848_ben)."</td>
                    <td>$".number_format($p0848_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0850_ben)."</td>
                    <td>$".number_format($p0850_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0852_ben)."</td>
                    <td>$".number_format($p0852_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0858_ben)."</td>
                    <td>$".number_format($p0858_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0893_ben)."</td>
                    <td>$".number_format($p0893_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0923_ben)."</td>
                    <td>$".number_format($p0923_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0929_ben)."</td>
                    <td>$".number_format($p0929_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($p0938_ben)."</td>
                    <td>$".number_format($p0938_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS072_ben)."</td>
                    <td>$".number_format($pS072_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS174_ben)."</td>
                    <td>$".number_format($pS174_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS176_ben)."</td>
                    <td>$".number_format($pS176_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS243_ben)."</td>
                    <td>$".number_format($pS243_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS283_ben)."</td>
                    <td>$".number_format($pS283_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS285_ben)."</td>
                    <td>$".number_format($pS285_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS286_ben)."</td>
                    <td>$".number_format($pS286_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS287_ben)."</td>
                    <td>$".number_format($pS287_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS290_ben)."</td>
                    <td>$".number_format($pS290_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    echo "<tr>
                    <td>Fertilizantes</td>
                    <td>".number_format($pS292_ben)."</td>
                    <td>$".number_format($pS292_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pS311_ben)."</td>
                    <td>$".number_format($pS311_monto)."</td>
                    </tr>";
                    }else{}
                    ...
                    <td>".number_format($pU021_ben)."</td>
                    <td>$".number_format($pU021_monto)."</td>
                    </tr>";
                    }else{}
                 }
                ?>
            ...
            <br>
            <h4 class='mt-4'>FAEISPUM 2022</h4>
...
<table class="table" style='font-family: Arial, Helvetica, sans-serif; font-size:0.8em; text-align:center'>
                <thead>
                    <tr class='TRTabla'>
            ...
            while ($row=mysqli_fetch_object($coneval)){
                ...
                echo "
                <tr><td colspan='3' class='cabezaTabla' style='background-color:#ffc3d0'>Pobreza</td></tr>
                <tr>
                <td>Pobreza</td>
                ...
                <tr><td colspan='3' class='cabezaTabla' style='background-color:#ffc3d0'>Vulenarbilidad</td></tr>
                <tr>
                <td>Vulnerable por carencia social</td>
                <td>".number_format($vulnerable_por_carencia_social )."%</td>
                <td>".number_format($ranking4)."</td>
                </tr>
                <tr>
                <td>Vulnerable por ingreso</td>
                ...
                <tr><td colspan='3' class='cabezaTabla' style='background-color:#ffc3d0'>Carencias</td></tr>
                <tr>
            ...
            <h4 class="mt-4">PRODUCCIÓN AGRÍCOLA 2020 <br>
                <?
            ...
            <table class="table" style='font-family: Arial, Helvetica, sans-serif; font-size:0.7em; text-align:center'>
                <thead>
                    <tr class='TRTabla'>
                        <td>Cultivo</td>
                        <td>Sembrada (ha)</td>
            ...
            <td>".number_format(($Valor/$totalValor)*100,2)."%</td>
            <td>".$Asacrificado."</td>
            </tr>
            ";
            };
        ...
        <br>
        <div class="row" style="background-color: #e2e2e2; padding:20px; font-size:0.9em; text-align:center;"> SIIM::Sistema de Integral de Información Municipal<br>Secretaría Técnica del Despacho del Gobernador</div>
